from PySide6.QtWidgets import QWidget,QVBoxLayout, QLineEdit, QComboBox, QPushButton, QLabel, QStackedWidget
import json, socket
...
class SignupPage(QWidget):
    def __init__(self, client, start_page, parent=None):
        ...
        self.layout().addWidget(self.input_firstname)
        ...
        self.layout().addWidget(self.input_access_p)
        ...
        self.layout().addWidget(self.input_access_n)
        ...
        self.layout().addWidget(self.input_access_b)
